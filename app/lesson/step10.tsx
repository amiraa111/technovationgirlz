...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'NextLessonScreen11'>;
...
export default function NextLessonScreen10() {
  ...
  const answers: Answer[] = [
    { text: 'отвечу положительно', isCorrect: false },
    { text: 'отвечу "не слышу"', isCorrect: false },
    { text: 'сброшу звонок', isCorrect: true },
  ];
  ...
  const getButtonStyle = (index: number, isSelected: boolean, isCorrectAnswer: boolean) => {
    const buttonStyle: Array<Partial<typeof styles.answerButton>> = [styles.answerButton];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.textBox}>
        ...
        <Text style={styles.text2}>
          В звонке вас спросили "вы меня{'\n'}слышите?". Что вы сделаете?
        </Text>
      ...
      {answered && (
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('NextLessonScreen11')}
        >
