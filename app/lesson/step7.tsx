...
const NextLessonScreen7: React.FC = () => {
  ...
  const getButtonStyle = (index: number) => {
    ...
    if (answered) {
      if (selectedIndex === index && answers[index].isCorrect) style.push(styles.correct);
      if (selectedIndex === index && !answers[index].isCorrect) style.push(styles.incorrect);
      if (selectedIndex !== index && answers[index].isCorrect) style.push(styles.correct);
      if (selectedIndex !== index && !answers[index].isCorrect) style.push(styles.answerButton); // Default style if not selected and not correct
    }
    return style;
  };
    ...
    <View style={styles.container}>
      ...
      {answered && (
        <TouchableOpacity
          ...
          onPress={() => router.push('/next-lesson-8')}
        >
...
export default NextLessonScreen7;
