...
type LessonScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'LessonScreen'>;
...
const LessonScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textBox}>
        <Text style={styles.warningTitle}>НЕ ВОЛНУЙТЕСЬ!</Text>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('NextLessonScreen1', { step: 1 })}
      >
