...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'NextLesson2Screen4'>;

export default function NextLesson2Screen4() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('NextLesson2Screen5')}
      >
