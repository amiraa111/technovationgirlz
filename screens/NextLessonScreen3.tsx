...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'NextLessonScreen3'>;

export default function NextLessonScreen3() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('NextLessonScreen4')}
      >
